function [mi,mai, ri, tstamp, projdir, di]  = proj_vnprl_cluster(varargin)
% proj_acs_dsg2014
% Cluster computing version of proj_vnprl
% This will just use F2, and not have 'version' as an argument, since that
% requires an eval, and the MATLAB auto parser will probably not be able to
% detect that. 
%
...
% eval(['mcmc_info = mcmc_info_vnprl_' p.ver '(mobj);']) % this will need to be attached. 
